...
- [ ] **Sensor Calibration:** Implement scripts to calculate sensor bias (offsets) for the accelerometer and gyroscope.
- [ ] **Digital Signal Processing (DSP):** Implement a **Kalman Filter** in Python to fuse IMU and Barometric data.
